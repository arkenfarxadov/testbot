...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="TGBOT" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" application.App %CMD_LINE_ARGS%
